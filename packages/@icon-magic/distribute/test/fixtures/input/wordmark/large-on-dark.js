 ...
 *
 * JS
 * import testPrefixWordmarkLargeOnDark './test-prefix-wordmark-large-on-dark';
 * testPrefixWordmarkLargeOnDark();
 *
 * HTML
 * <test-prefix-wordmark-large-on-dark></test-prefix-wordmark-large-on-dark>
 */
export default function () {
  // Can't register the same tag more than once. Throws DOMException.
  if (window && !window.customElements.get('test-prefix-wordmark-large-on-dark')) {
    window.customElements.define(
      'test-prefix-wordmark-large-on-dark',

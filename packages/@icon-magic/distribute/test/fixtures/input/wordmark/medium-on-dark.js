 ...
 *
 * JS
 * import testPrefixWordmarkMediumOnDark './test-prefix-wordmark-medium-on-dark';
 * testPrefixWordmarkMediumOnDark();
 *
 * HTML
 * <test-prefix-wordmark-medium-on-dark></test-prefix-wordmark-medium-on-dark>
 */
export default function () {
  // Can't register the same tag more than once. Throws DOMException.
  if (window && !window.customElements.get('test-prefix-wordmark-medium-on-dark')) {
    window.customElements.define(
      'test-prefix-wordmark-medium-on-dark',

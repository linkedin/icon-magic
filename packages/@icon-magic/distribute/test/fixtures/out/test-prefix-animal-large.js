 ...
 *
 * JS
 * import testPrefixAnimalLarge './test-prefix-animal-large';
 * testPrefixAnimalLarge();
 *
 * HTML
 * <test-prefix-animal-large></test-prefix-animal-large>
 */
export default function () {
  // Can't register the same tag more than once. Throws DOMException.
  if (window && !window.customElements.get('test-prefix-animal-large')) {
    window.customElements.define(
      'test-prefix-animal-large',
